% Conducts a velocity analysis of the Stephenson Type III sixbar linkage
% and plots the velocity of point E.
...
Derivative_Plot(theta2,xE(1,:),vE(1,:), dt)   % verify derivatives
 
% Plot the velocity of point E
figure
plot(theta2*180/pi,vE(1,:),'Color',[153/255 153/255 153/255])
hold on
plot(theta2*180/pi,vE(2,:),'Color',[0/255 153/255 76/255])
legend('v_E_x','v_E_y','Location','Southeast')
title('Velocity of point E on Stephenson Type III Linkage')
...
% Save the plot
saveas(gcf, 'Sixbar_StephensonType3_Velocity_Analysis - plot.png')
