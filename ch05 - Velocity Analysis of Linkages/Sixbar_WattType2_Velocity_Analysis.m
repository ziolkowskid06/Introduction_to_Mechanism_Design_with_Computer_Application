% Conducts a velocity analysis on the Watt Type II sixbar linkage
...
title('Velocity of point G on Watt Type II Linkage')
...
% Save the plot
saveas(gcf, 'Sixbar_WattType2_Velocity_Analysis - plot.png')
