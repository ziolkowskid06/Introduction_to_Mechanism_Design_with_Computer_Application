% Conducts a velocity analysis on the slider-crank linkage and
% plots the piston velocity as a function of crank angle
% by Damian Ziolkowski, February 5, 2022
...
title('Piston velocity on Slider-Crank')
...
% Save the plot
saveas(gcf, 'SliderCrank_Velocity_Analysis - plot1.png')