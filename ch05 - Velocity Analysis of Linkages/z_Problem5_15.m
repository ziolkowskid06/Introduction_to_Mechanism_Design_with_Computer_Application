% Problem 5.15 (Inverted Slider-Crank linkage)
...
figure
plot(theta2*180/pi,vP(1,:),'Color',[0/255 240/255 240/255])
hold on
plot(theta2*180/pi,vP(2,:),'Color',[0/255 153/255 76/255])
plot(theta2*180/pi,   bdot,'Color',[0/255   0/255  0/255])
legend('v_P_x','v_P_y','slip','Location','Southeast')
title('Velocity of point P and slip on Inverted Slider-Crank Linkage')
