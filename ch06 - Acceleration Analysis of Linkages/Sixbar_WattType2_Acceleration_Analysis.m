% Conducts an acceleration analysis on the Watt Type II sixbar linkage
% and plots the acceleration of point G.
% by Damian Ziolkowski, February 20, 2021
...
[vB,vC,vE,vG]                        = deal(zeros(2,N)); % velocities
[aB,aC,aE,aG]                        = deal(zeros(2,N)); % accelerations
...
legend('a_G_x','a_G_y','Location','Northeast')
title('Acceleration of point G on Watt Type II Linkage')
...
% Save the plot
saveas(gcf, 'Sixbar_WattType2_Acceleration_Analysis - plot.png')
