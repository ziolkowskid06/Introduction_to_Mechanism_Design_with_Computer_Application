% Conducts an acceleration analysis on the slider-crank linkage and
% plots the piston acceleration as a function of crank angle
...
% Save the plot
saveas(gcf, 'SliderCrank_Acceleration_Analysis - plot1.png')