% Conducts an acceleration analysis on the threebar crank-slider linkage
% and plots the acceleration of point P
% by Damian Ziolkowski, February 9, 2021
...
[aB,aP]             = deal(zeros(2, N)); % allocate space for accelerations of B,P
[theta2,theta3]     = deal(zeros(1, N)); % allocate space for link angles
[b,bdot,bddot]      = deal(zeros(1, N)); % allocate space for b, bdot, bddot
[omega3,alpha3]     = deal(zeros(1, N)); % allocate space for angular velocity and acceleration
...
% Save the plot
saveas(gcf, 'Threebar_Acceleration_Analysis - plot1.png')