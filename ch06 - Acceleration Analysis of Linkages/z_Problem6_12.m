% Problem 6.12 (Inverted slider-crank linkage)
...
% Plot the acceleration of slip bddot
figure
plot(theta2*180/pi,bddot,'Color',[0/255 153/255 76/255])
title('Acceleration of slip on Inverted Slider-Crank Linkage')
xlabel('Crank angle (\circ)')
ylabel('Acceleration (m/s^2)')
grid on
set(gca,'xtick',0:60:360)
