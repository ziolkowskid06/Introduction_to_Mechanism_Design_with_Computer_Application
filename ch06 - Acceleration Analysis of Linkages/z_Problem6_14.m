% Problem 6.14 (Stephenson Type I sixbar linkage)
...
[vB,vC,vE,vF,vG,vP]                  = deal(zeros(2,N)); % velocities
[aB,aC,aE,aF,aG,aP]                  = deal(zeros(2,N)); % accelerations
...
% Calculate velocity at important points on linkage
  ...
  vG(:,i) = FindVel(vF(:,i),   v, omega6(i),   n6);
  vP(:,i) = FindVel(vF(:,i),   z, omega6(i),  nFP);
...
% Find acceleration of pins
  ...
  aP(:,i) = FindAcc(aF(:,i), z, omega6(i), alpha6(i), eFP, nFP);
end
...
title('Acceleration of point P on Stephenson Type I Linkage')
